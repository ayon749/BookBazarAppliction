...
namespace BookBazar.Areas.Admin.Controllers
{
    ...
    public class Product : Controller
    {
        ...
        public IActionResult Upsert(int? id)
        {
            ...
            {
                Product = new BookBazar.Models.Product(),
        ...
        public IActionResult Upsert(ProductVM productvm)
        {
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    {
                        BookBazar.Models.Product productFromDb = _iUnitOfWork.product.Get(productvm.Product.Id);
            ...
            {
                IEnumerable<BookBazar.Models.Catagory> CatList = _iUnitOfWork.Catagory.GetAll();
